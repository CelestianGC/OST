/*
 * Option_List_NonWeaponProfs.java
 *
...
public class Option_List_NonWeaponProfs extends javax.swing.JDialog {
			...
			for (Object oSelected : oSelect)
				if (oSelected != null) {
					...
					if (bDelete
						...
						bDelete = true;
						ost.nonWeaponProfList.getContent().remove(o);
	...
	private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		Object oSelected = mainList.getSelectedValue();
		if (oSelected != null && oSelected instanceof NonWeaponProfClass) {
			NonWeaponProfClass o = (NonWeaponProfClass) oSelected;

			Option_AskFor_NonWeaponProf dDialog = new Option_AskFor_NonWeaponProf(
					parent, true, ost, o);
	...
	private void createButtonActionPerformed(java.awt.event.ActionEvent evt) {
		// TODO add your handling code here:
		NonWeaponProfClass oNew = new NonWeaponProfClass("newNonWeaponProf",
				"Enter Description of this new non-weapon prof.");
		ost.nonWeaponProfList.add(oNew);
