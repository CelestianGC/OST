 ...
 * @author  __USER__
 */
public class Option_Set_Race extends javax.swing.JDialog {
	...
	private void updateAllowed(JList list, ArrayList<RaceClass> aList) {
		DefaultListModel model = (DefaultListModel) list.getModel();
		Object oSelected = list.getSelectedValue();
		model.removeAllElements();
		for (Object o : aList)
	...
	private void extraModifyButtonActionPerformed(java.awt.event.ActionEvent evt) {
		Option_List_Races dDialog = new Option_List_Races(parent, true, ost);
