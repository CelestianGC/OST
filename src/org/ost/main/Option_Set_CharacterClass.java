/*
 * Option_Set_CharacterClass.java
 *
 ...
 * @author  __USER__
 */
public class Option_Set_CharacterClass extends javax.swing.JDialog {
	...
	private void updateList(JList list, CharacterClassList aList) {
	...
	private void updateAllowed(JList list, ArrayList<CharacterClass> aList) {
		DefaultListModel model = (DefaultListModel) list.getModel();
		Object oSelected = list.getSelectedValue();
		model.removeAllElements();
		for (Object o : aList)
	...
	private void extraModifyButtonActionPerformed(java.awt.event.ActionEvent evt) {
		Option_List_CharacterClasses dDialog = new Option_List_CharacterClasses(parent,
				true, ost);
